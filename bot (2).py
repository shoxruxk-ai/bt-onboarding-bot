...
async def process_message(
    ...
    try:
        ...
        # Gemini may return markdown that breaks Telegram parser — fallback to plain text
        try:
        ...
        error_detail = str(e)
        print(f"[ERROR] Gemini call failed: {error_detail}")  # visible in Railway logs
        errors = {
            "ru": f"⚠️ Ошибка: {error_detail[:200]}\n\nИли напишите на hr@bakertilly.uz",
            "uz": f"⚠️ Xatolik: {error_detail[:200]}\n\nYoki hr@bakertilly.uz ga yozing",
        }
